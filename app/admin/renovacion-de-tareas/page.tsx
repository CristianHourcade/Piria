...
import { CheckCircle2, Clock, AlertTriangle, RefreshCw, CalendarIcon } from "lucide-react"
...
const CLIENTS_WITH_AUTO_RENEWAL = [
  {
    id: 1,
    name: "Empresa ABC",
    service: "Diseño Web",
...
export default function RenovacionTareasPage() {
  const [clients, setClients] = useState(CLIENTS_WITH_AUTO_RENEWAL)
  const [renewalHistory] = useState(RENEWAL_HISTORY)
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-secondary dark:text-gray-200">Renovación de Tareas</h1>
          <p className="text-muted-foreground">Gestiona la renovación automática de tareas para clientes</p>
        </div>
        <Button onClick={() => setIsRenewAllDialogOpen(true)}>
      ...
      <AlertDialog open={isRenewAllDialogOpen} onOpenChange={setIsRenewAllDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction onClick={handleRenewAllTasks}>Confirmar Renovación</AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
    </div>
